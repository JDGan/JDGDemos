//
//  JDGDesignPattenTableViewController.m
//  DemoCenter
//
...
#import "JDGDesignPattenTableViewController.h"

@interface JDGDesignPattenTableViewController ()
{
...
@implementation JDGDesignPattenTableViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"DesignPatten" ofType:@"plist"];
...
{
    static NSString *CellIdentifier = @"DesignPattenMainCell";
